...
/// The day the evening card was waved away on, kept on her own phone.
///
/// Nothing goes to Firestore: closing a card says something about her evening,
/// not about the child.
const _key = 'reflection_dismissed_day';

class ReflectionStore extends Notifier<DateTime?> {
  @override
  DateTime? build() {
...
final reflectionStoreProvider =
    NotifierProvider<ReflectionStore, DateTime?>(ReflectionStore.new);
